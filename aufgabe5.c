...
int main() {
    ...
    //Entfernen aller Zeichen außer die Buchstaben a-z und füllt den Rest mit Nullbytes
    int j = 0;
    ...
    //Erzeuge ein Array, dass genau so lang ist wie das Wort selbst
    ...
    //Vergleicht die beiden Arrays und findet Palindrome
